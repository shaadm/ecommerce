    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-12">
                <h4 class="font-rubik font-size-20">SNF Car Company</h4>
                <p class="font-size-14 font-rale text-white-50">Drive with Passion</p>
            </div>
            <div class="col-lg-4 col-12">
                ...
                <div class="col-lg-2 col-12">
                    ...
                    <div class="d-flex flex-column flex-wrap">
                        ...
                        <a href="deliveryinfo.php" class="font-rale font-size-14 text-white-50 pb-1">Delivery Information</a>
...
<div class="copyright text-center bg-dark text-white py-2">
    <p class="font-rale font-size-14">&copy; Copyrights 2022. Desing By <a href="#" class="color-second">shaadmahamod</a></p>
  </div>
<!-- !start #footer -->
