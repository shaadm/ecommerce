            ...
            <div class="row">
                ...
                ?>
                    <!-- cart item -->
                        <div class="row border-top py-3 mt-3">
                            <div class="col-sm-2">
                                <img src="<?php echo $item['item_image'] ?? "./assets/products/M2Sport.PNG" ?>" style="height: auto;" alt="cart1" class="img-fluid">
                            </div>
                            <div class="col-sm-8">
                                ...
                                <div class="qty d-flex pt-2">
                                        <div class="d-flex font-rale w-25">
                                            ...
                                            <button data-id="<?php echo $item['item_id'] ?? '0'; ?>" class="qty-down border bg-light"><i class="fas fa-angle-down"></i></button>                                        </div>
                ...
                <div class="col-sm-3">
                    <div class="sub-total border text-center mt-2">
                        ...
                        <a href="proceedtobuy.php" button type="submit" class="btn btn-warning mt-3">Proceed to Buy</button><a>                        
