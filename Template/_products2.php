...
<section id="product" class="py-3">
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
            <img src="<?php echo $item['item_image'] ?? "./assets/BMW/8/CoupeMSport.PNG" ?>" alt="product" class="img-fluid">
            ...
            <small>by <?php echo $item['item_brand'] ?? "Brand"; ?></small>
                ...
                <table class="my-3">
                    ...
                    <tr class="font-rale font-size-14">
                     ...
                     <tr class="font-rale font-size-14">
                        <td>You Save:</td> 
                        <td><span class="font-size-16 text-danger">$2,590</span></td>
                ...
                <div id="policy">
                    <div class="d-flex">
                        ...
                        <div class="return text-center mr-5">
                            ...
                            <a href="#" class="font-rale font-size-12">SNF Company<br>Deliverd</a>
                        </div>
                        <div class="return text-center mr-5">
                            <div class="font-size-20 my-2 color-second">
                ...
                <div class="col-12">
                    ...
                    <hr>
                    <div class="col-sm-6 py-5">
            <h5 class="font-baloo font-size-20"><?php echo $item['item_specs'] ?? "Unknown"; ?></h5>
            <small>by <?php echo $item['item_brand'] ?? "Brand"; ?></small>
            </div>
        </div>
    </div>
